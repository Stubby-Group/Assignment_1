...
flatPrior <- function(teacherInitial, plotTitle){
  dens <- 100
...
ggpubr::ggarrange(flatPrior("R", "Riccardo"),
                  flatPrior("K", "Kristian"),
                  flatPrior("D", "Daina"),
                  flatPrior("M", "Mikkel"), 
                  ncol = 2, nrow = 2)
```
...
ggpubr::ggarrange(customPrior(0.8, 0.2, "R", "Riccardo"),
                  customPrior(0.8, 0.2, "K", "Kristian"),
                  customPrior(0.8, 0.2, "D", "Daina"),
