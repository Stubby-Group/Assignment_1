...
```{r}
flatPrior <- function(plotTitle, teacherInitial){
...
customPrior <- function(plotTitle, prior_mean, prior_sd, teacherInitial){
  P_grid <- tibble(p_grid = seq(from = 0, to = 1, length.out = 101),
...
ggpubr::ggarrange(gridFunction("Riccardo", 0.8, 0.2, "R"), 
                  gridFunction("Kristian", 0.8, 0.2, "K"), 
                  gridFunction("Diana", 0.8, 0.2, "D"), 
                  gridFunction("Mikkel", 0.8, 0.2, "M"), 
                  #labels = c("Riccardo", "Kristian", "Daina", "Mikkel"),
                  ncol = 2, nrow = 2)
```
